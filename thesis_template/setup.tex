...
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{figures/thesis-architecture-tech.png}
    \caption{System Architecture Overview: the tech stack}
    \label{fig:architecture-tech-stack}
\end{figure}
