...
for data at rest in real-world applications, in particular,
file sharing on public cloud as our target.
We design and implement
a Secure Shared Folder (SSF) scheme, 
building on the Group Key Progression primitive from Backendal, B{\'a}lbas and Haller.
...
Together, these issues represent gaps
that need to be addressed by implementors 
to make the system production-ready.
Furthermore, the implementation uncovered errors in the pseudocode
...
With this work, we also provide a survey of the 
state-of-the-art technology we considered during the implementation,
