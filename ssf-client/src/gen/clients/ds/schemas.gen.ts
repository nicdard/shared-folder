...
export const $ApplicationMessageRequest = {
  type: 'object',
  description: 'Patch a proposal, publishing an application message.',
  required: ['payload', 'message_ids'],
  properties: {
    message_ids: {
      type: 'array',
      items: {
...
export const $GroupMessage = {
  type: 'object',
  required: ['message_id', 'folder_id', 'payload', 'application_payload'],
  properties: {
    application_payload: {
      type: 'string',
      format: 'binary',
...
export const $ProposalMessageRequest = {
  type: 'object',
